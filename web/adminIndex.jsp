...
<!--End of Manage Post Header-->
    ...
    <div style="margin:10px auto; padding:20px; width:1228px;">
        ...
        <div class="box">
            ...
            <a href="CampusAccess1.jsp"><button class="buttonc button1">Read More</button></a>
        </div>
        ...
        <div class="box">
            ...
            <a href="GoingOut1.jsp"><button class="buttonc button1">Read More</button></a>
        </div>
    ...
    <div style="margin-bottom:50px; padding-bottom: 50px; background: #F4F4F4;">
        <div style="margin:30px auto; padding-top:40px; width:1228px;">
            ...
            <div style="margin-top: 30px;">
                ...
                <a href="adminPost.jsp?pid=<%=rs_post.getString("pid")%>">
                ...
                <div style="margin-top:50px; width: 950px; height: 250px; background: #FFFFFF;border: 1px solid #8E8E8E;box-sizing: border-box;border-radius: 25px;float: right;padding: 20px; text-decoration: none;">
                    <a style="text-decoration: none" href="adminPost.jsp?pid=<%=rs_post.getString("pid")%>"><div style="margin:30px 0px 0px 30px;font-size: 32px; font-weight: 500; color: #263E7B;"><%=rs_post.getString("title")%></div></a>
